...
public class ArmSubsystem extends SubsystemBase {
    ...
    double initialRelativeEncoderPosition = relativeEncoder.getPosition();
    ...
    public ArmSubsystem() {
        ...
        relativeEncoder.setPositionConversionFactor(Constants.positionalConversionfactor);
    }
    ...
    public void periodic() {
        ...
        System.out.println("Relative " + (result));
        // System.out.println("Absolute " + absoluteEncoder.getPosition());
        SmartDashboard.putNumber("Relative Encoder", result - initialRelativeEncoderPosition);
